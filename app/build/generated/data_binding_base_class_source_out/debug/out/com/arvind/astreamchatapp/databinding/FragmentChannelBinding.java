...
public final class FragmentChannelBinding implements ViewBinding {
  ...
  public static FragmentChannelBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ChannelListHeaderView channelListHeaderView = ViewBindings.findChildViewById(rootView, id);
      if (channelListHeaderView == null) {
        break missingId;
      }

      id = R.id.channelsView;
      ChannelListView channelsView = ViewBindings.findChildViewById(rootView, id);
