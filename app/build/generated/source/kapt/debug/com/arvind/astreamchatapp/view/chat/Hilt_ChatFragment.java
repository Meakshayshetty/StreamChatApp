 ...
 */
public abstract class Hilt_ChatFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChatFragment_GeneratedInjector) this.generatedComponent()).injectChatFragment(UnsafeCasts.<ChatFragment>unsafeCast(this));
    }
  }
