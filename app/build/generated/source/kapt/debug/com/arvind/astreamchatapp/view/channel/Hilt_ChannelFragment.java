 ...
 */
public abstract class Hilt_ChannelFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChannelFragment_GeneratedInjector) this.generatedComponent()).injectChannelFragment(UnsafeCasts.<ChannelFragment>unsafeCast(this));
    }
  }
